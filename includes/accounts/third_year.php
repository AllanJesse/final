                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">View All Third Year Receipts
                                ...
                                <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        $query = "SELECT u.firstname as firstname, f.first3 as first3, f.semester3 as semester3, f.id as id, f.status as status FROM finance f INNER JOIN users u on u.id=f.user_id";
                                                ...
                                                <tr>
                                                    ...
                                                    <td class="text-center">
                                                        <div class="widget-content-center">
                                                            <div class="widget-heading"><?php echo $row['first3']; ?></div>
                                                        </div>
                                                    </td>

                                                    <td class="text-center">
                                                        <div class="widget-content-center">
                                                            <div class="widget-heading"><?php echo $row['semester3']; ?></div>
                                                        </div>
                                                    </td>
                                    ...
                                    <div class="d-block text-center card-footer">
                                        <button class="btn-wide btn btn-success"><a href="printThree.php"><i class="metismenu-icon pe-7s-file"></i>Print</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
