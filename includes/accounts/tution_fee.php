                    ...
                    <div class="row">
                        <div class="col-md-12">
                            <div class="main-card mb-3 card">
                                <div class="card-header">View All Receipts
                                ...
                                <div class="table-responsive">
                                    <table class="align-middle mb-0 table table-borderless table-striped table-hover">
                                        ...
                                        <thead>
                                            ...
                                            <th class="text-center">#</th>
                                                ...
                                                <th class="text-center">Semester One</th>
                                                <th class="text-center">Semester Two</th>
                                                <th class="text-center">Semester Three</th>
                                                <th class="text-center">Semester Four</th>
                                                <th class="text-center">Semester Five</th>
                                                <th class="text-center">Semester Six</th>
                                        ...
                                        while ($row = mysqli_fetch_assoc($result)) { ?>
                                            <tbody>
                                                <tr>
                                                    ...
                                                    <td class="text-center"><?php echo $row['semester1']; ?></td>
                                                    <td class="text-center"><?php echo $row['first2']; ?></td>
                                                    <td class="text-center"><?php echo $row['semester2']; ?></td>
                                                    <td class="text-center"><?php echo $row['first3']; ?></td>

                                                    <td class="text-center">
                                                        <div class="text-center"><?php echo $row['semester3']; ?></div>
                                                    </td>
                                    ...
                                    <div class="d-block text-center card-footer">
                                        <button class="btn-wide btn btn-success"><a href="printFee.php"><i class="metismenu-icon pe-7s-file"></i>Print</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
