                        ...
                        <div class="row">
                            <div class="col-md-12">
                                <div class="main-card mb-3 card">
                                    <div class="card-header">Active Staffs
                                    ...
                                    <div class="d-block text-center card-footer">
                                        <button class="btn-wide btn btn-success"><a href="printStaffs.php"><i class="metismenu-icon pe-7s-file"></i>Print User</a></button>
                                    </div>
                                </div>
                            </div>
                        </div>
